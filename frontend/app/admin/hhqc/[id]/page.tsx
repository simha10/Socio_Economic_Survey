...
export default function HHQCEditPage() {
  ...
  const [originalData, setOriginalData] = useState<HouseholdSurvey | null>(
    null,
  );
    ...
    const fetchSurveyData = async () => {
      try {
        ...
        const response = await apiService.get(
          `/surveys/household-surveys/${params.id}`,
        );
        ...
        alert(
          "Failed to load survey data. Please check the console for details.",
        );
      } finally {
        setLoading(false);
      }
    ...
    (field: string, value: string | number | undefined | string[]) => {
      ...
      setFormData((prev) => {
        ...
        if (field === "familyMembersMale" || field === "familyMembersFemale") {
          const male =
            field === "familyMembersMale" ? value : prev.familyMembersMale;
          const female =
            field === "familyMembersFemale" ? value : prev.familyMembersFemale;
          updatedData.familyMembersTotal =
        ...
        if (
          ...
          const male =
            field === "illiterateAdultMale" ? value : prev.illiterateAdultMale;
          const female =
            field === "illiterateAdultFemale"
              ? value
              : prev.illiterateAdultFemale;
          updatedData.illiterateAdultTotal =
            (Number(male) || 0) + (Number(female) || 0);
        }
        ...
        if (
          ...
          const male =
            field === "childrenNotAttendingMale"
              ? value
              : prev.childrenNotAttendingMale;
          const female =
            field === "childrenNotAttendingFemale"
              ? value
              : prev.childrenNotAttendingFemale;
          updatedData.childrenNotAttendingTotal =
            (Number(male) || 0) + (Number(female) || 0);
        }
        ...
        if (
          ...
          const physical =
            field === "handicappedPhysically"
              ? value
              : prev.handicappedPhysically;
          const mental =
            field === "handicappedMentally" ? value : prev.handicappedMentally;
          updatedData.handicappedTotal =
            (Number(physical) || 0) + (Number(mental) || 0);
        }

        if (field === "earningAdultMale" || field === "earningAdultFemale") {
          const male =
            field === "earningAdultMale" ? value : prev.earningAdultMale;
          const female =
            field === "earningAdultFemale" ? value : prev.earningAdultFemale;
          updatedData.earningAdultTotal =
            (Number(male) || 0) + (Number(female) || 0);
        }
        ...
        if (
          ...
          const male =
            field === "earningNonAdultMale" ? value : prev.earningNonAdultMale;
          const female =
            field === "earningNonAdultFemale"
              ? value
    ...
    try {
      ...
      if (response.success) {
        ...
        if (response.error && (response.error as any).validationErrors) {
          ...
          alert(
            "Validation failed for some fields. Please check the highlighted fields.",
          );
        } else {
          alert(
    ...
    return (
      ...
      >
        <div className="flex items-center justify-center min-h-[60vh]">
          <LoadingSpinner size="lg" text="Loading household survey data..." />
        </div>
      </SupervisorAdminLayout>
    );
  }
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
              <label className="flex items-center space-x-2">
                <input
                  type="checkbox"
                  checked={
                    formData.welfareBenefits?.includes("OLD_AGE_PENSION") ||
                    false
                  }
                  onChange={(e) => {
                    const newBenefits = e.target.checked
                      ? [...(formData.welfareBenefits || []), "OLD_AGE_PENSION"]
                      : formData.welfareBenefits?.filter(
                          (item) => item !== "OLD_AGE_PENSION",
                        ) || [];
              ...
              <label className="flex items-center space-x-2">
                <input
                  type="checkbox"
                  checked={
                    formData.welfareBenefits?.includes("WIDOW_PENSION") || false
                  }
                  onChange={(e) => {
                    const newBenefits = e.target.checked
                      ? [...(formData.welfareBenefits || []), "WIDOW_PENSION"]
                      : formData.welfareBenefits?.filter(
                          (item) => item !== "WIDOW_PENSION",
                        ) || [];
                    handleInputChange("welfareBenefits", newBenefits);
                  }}
                  className="rounded text-blue-600 focus:ring-blue-500"
              ...
              <label className="flex items-center space-x-2">
                <input
                  type="checkbox"
                  checked={
                    formData.welfareBenefits?.includes("DISABLED_PENSION") ||
                    false
                  }
                  onChange={(e) => {
                    const newBenefits = e.target.checked
              ...
              <label className="flex items-center space-x-2">
                <input
                  type="checkbox"
                  checked={
                    formData.welfareBenefits?.includes("HEALTH_INSURANCE") ||
                    false
                  }
                  onChange={(e) => {
                    const newBenefits = e.target.checked
              ...
              <label className="flex items-center space-x-2">
                <input
                  type="checkbox"
                  checked={
                    formData.welfareBenefits?.includes("GENERAL_INSURANCE") ||
                    false
                  }
                  onChange={(e) => {
                    const newBenefits = e.target.checked
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
              <label className="flex items-center space-x-2">
                <input
                  type="checkbox"
                  checked={
                    formData.consumerDurables?.includes("ELECTRIC_FAN") || false
                  }
                  onChange={(e) => {
                    const newDurables = e.target.checked
                      ? [...(formData.consumerDurables || []), "ELECTRIC_FAN"]
                      : formData.consumerDurables?.filter(
                          (item) => item !== "ELECTRIC_FAN",
                        ) || [];
              ...
              <label className="flex items-center space-x-2">
                <input
                  type="checkbox"
                  checked={
                    formData.consumerDurables?.includes("REFRIGERATOR") || false
                  }
                  onChange={(e) => {
                    const newDurables = e.target.checked
              ...
              <label className="flex items-center space-x-2">
                <input
                  type="checkbox"
                  checked={
                    formData.consumerDurables?.includes("COOLER") || false
                  }
                  onChange={(e) => {
                    const newDurables = e.target.checked
              ...
              <label className="flex items-center space-x-2">
                <input
                  type="checkbox"
                  checked={
                    formData.consumerDurables?.includes(
                  ...
                  onChange={(e) => {
                    const newDurables = e.target.checked
                      ...
                      : formData.consumerDurables?.filter(
                          (item) => item !== "RESIDENTIAL_TELEPHONE",
                        ) || [];
                    handleInputChange("consumerDurables", newDurables);
                  }}
                  className="rounded text-blue-600 focus:ring-blue-500"
              ...
              <label className="flex items-center space-x-2">
                <input
                  type="checkbox"
                  checked={
                    formData.consumerDurables?.includes("MOBILE_PHONE") || false
                  }
                  onChange={(e) => {
                    const newDurables = e.target.checked
                ...
                <input
                  ...
                  onChange={(e) => {
                    const newDurables = e.target.checked
                      ...
                      : formData.consumerDurables?.filter(
                          (item) => item !== "BLACK_WHITE_TELEVISION",
                        ) || [];
                    handleInputChange("consumerDurables", newDurables);
                  }}
                  className="rounded text-blue-600 focus:ring-blue-500"
              ...
              <label className="flex items-center space-x-2">
                <input
                  type="checkbox"
                  checked={
                    formData.consumerDurables?.includes("COLOR_TELEVISION") ||
                    false
                  }
                  onChange={(e) => {
                    const newDurables = e.target.checked
              ...
              <label className="flex items-center space-x-2">
                <input
                  type="checkbox"
                  checked={
                    formData.consumerDurables?.includes("SEWING_MACHINE") ||
                    false
                  }
                  onChange={(e) => {
                    const newDurables = e.target.checked
              ...
              <label className="flex items-center space-x-2">
                <input
                  type="checkbox"
                  checked={
                    formData.consumerDurables?.includes("FURNITURE") || false
                  }
                  onChange={(e) => {
                    const newDurables = e.target.checked
              ...
              <label className="flex items-center space-x-2">
                <input
                  type="checkbox"
                  checked={
                    formData.consumerDurables?.includes("BICYCLE") || false
                  }
                  onChange={(e) => {
                    const newDurables = e.target.checked
              ...
              <label className="flex items-center space-x-2">
                <input
                  type="checkbox"
                  checked={
                    formData.consumerDurables?.includes("RICKSHAW") || false
                  }
                  onChange={(e) => {
                    const newDurables = e.target.checked
              ...
              <label className="flex items-center space-x-2">
                <input
                  type="checkbox"
                  checked={
                    formData.consumerDurables?.includes("PUSH_CART") || false
                  }
                  onChange={(e) => {
                    const newDurables = e.target.checked
              ...
              <label className="flex items-center space-x-2">
                <input
                  type="checkbox"
                  checked={
                    formData.consumerDurables?.includes("BULLOCK_CART") || false
                  }
                  onChange={(e) => {
                    const newDurables = e.target.checked
                      ? [...(formData.consumerDurables || []), "BULLOCK_CART"]
                      : formData.consumerDurables?.filter(
                          (item) => item !== "BULLOCK_CART",
                        ) || [];
                    handleInputChange("consumerDurables", newDurables);
                  }}
                  className="rounded text-blue-600 focus:ring-blue-500"
              ...
              <label className="flex items-center space-x-2">
                <input
                  type="checkbox"
                  checked={
                    formData.consumerDurables?.includes("TWO_WHEELER") || false
                  }
                  onChange={(e) => {
                    const newDurables = e.target.checked
                      ? [...(formData.consumerDurables || []), "TWO_WHEELER"]
                      : formData.consumerDurables?.filter(
                          (item) => item !== "TWO_WHEELER",
                        ) || [];
                    handleInputChange("consumerDurables", newDurables);
                  }}
                  className="rounded text-blue-600 focus:ring-blue-500"
              ...
              <label className="flex items-center space-x-2">
                <input
                  type="checkbox"
                  checked={
                    formData.consumerDurables?.includes("THREE_WHEELER") ||
                    false
                  }
                  onChange={(e) => {
                    const newDurables = e.target.checked
              ...
              <Select
                ...
                options={[
                  ...
                  },
                  {
                    ...
                    label: "Within Premises Tubewell",
                  },
                  {
                    value: "WITHIN_PREMISES_OPENWELL",
                    label: "Within Premises Openwell",
                  },
                  {
                  ...
                  },
                  {
                    ...
                    label: "Outside Premises Tube/Bore Well",
                  },
                  {
                    value: "OUTSIDE_PREMISES_OPENWELL",
                    label: "Outside Premises Openwell",
                  },
                  {
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
              <label className="flex items-center space-x-2">
                <input
                  type="checkbox"
                  checked={
                    formData.migrationReasons?.includes("UNEMPLOYMENT") || false
                  }
                  onChange={(e) => {
                    const newReasons = e.target.checked
                      ? [...(formData.migrationReasons || []), "UNEMPLOYMENT"]
                      : formData.migrationReasons?.filter(
                          (item) => item !== "UNEMPLOYMENT",
                        ) || [];
              ...
              <label className="flex items-center space-x-2">
                <input
                  type="checkbox"
                  checked={
                    formData.migrationReasons?.includes("LOW_WAGE") || false
                  }
                  onChange={(e) => {
                    const newReasons = e.target.checked
              ...
              <label className="flex items-center space-x-2">
                <input
                  type="checkbox"
                  checked={
                    formData.migrationReasons?.includes("DROUGHT") || false
                  }
                  onChange={(e) => {
                    const newReasons = e.target.checked
              ...
              <label className="flex items-center space-x-2">
                <input
                  type="checkbox"
                  checked={
                    formData.migrationReasons?.includes("CONFLICT") || false
                  }
                  onChange={(e) => {
                    const newReasons = e.target.checked
              ...
              <label className="flex items-center space-x-2">
                <input
                  type="checkbox"
                  checked={
                    formData.migrationReasons?.includes("EDUCATION") || false
                  }
                  onChange={(e) => {
                    const newReasons = e.target.checked
              ...
              <label className="flex items-center space-x-2">
                <input
                  type="checkbox"
                  checked={
                    formData.migrationReasons?.includes("MARRIAGE") || false
                  }
                  onChange={(e) => {
                    const newReasons = e.target.checked
              ...
              <label className="flex items-center space-x-2">
                <input
                  type="checkbox"
                  checked={
                    formData.migrationReasons?.includes("OTHERS") || false
                  }
                  onChange={(e) => {
                    const newReasons = e.target.checked
